...
$res = $cnn->query ("select aut_gamintojas from darbas where aut_kaina>{$kaina}");
while ($a = $res->fetch ()){
...
$res = $cnn->prepare ("select aut_gamintojas from darbas where aut_kaina>:kaina"); //parametrai serveryje
