<div class="site-header">
    <table class="mx-auto w-100">
        <tr>
            <td><img class="site-logo" src="http://gitanamac.lt/darbas/images/auto.png" alt="Automobilių nuomos internetinė informacinė sistema | UAB Auto 7/24"></td>
            <td>
                <h1 class="site-title">Automobilių nuoma 7/24</h1>
                <div class="row site-header-top-grid">
                    <div class="col p-0"><button class="btn m-0 p-0 pb-1 pl-2 pr-2"><i class="fa fa-phone pr-1" aria-hidden="true"></i>+370 655 926664</button></div>
    ...
    <div class="mx-auto">
        <nav class="navbar navbar-expand-sm m-0 p-0">
            <ul class="navbar-nav nav-pills">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/darbas/auto-actions.php"><i class="fa fa-car" aria-hidden="true"></i>Įdėti naują automobilį</a>
                </li>
            </ul>
        </nav>
    </div>
